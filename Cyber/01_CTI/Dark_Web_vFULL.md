...
- Ch.45 — Premier accès à Tor : installation, sécurité et navigation légitime
- Ch.46 — Authentifier un miroir officiel .onion
- Ch.47 — Collecter et documenter une source légitime avec Hunchly
- Ch.48 — Vérification défensive de l'exposition dans les bases de leaks publiques
